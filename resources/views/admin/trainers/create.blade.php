        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Dodaj trenera</div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ route('trainers.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
