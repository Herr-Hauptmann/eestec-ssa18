...
@section('content')
    <div class="marginContainer">
        <div class="container-fluid">
            ...
            <div class="row">
                <!-- <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij">
                ...
                <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-4 logoDiv-medij">
            ...
            <div class="logoContainer">
                ...
                <div class="row karuzoRow">
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-2 logoDiv-medij">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij karuzo">
                ...
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij swity">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij swity sens">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij nes">
                ...
                <div class="row ovcaRow">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij marbo">
                        <a><img alt="Marbo" class="img-responsive logoImg-medij pad" src="img/partneri/marbo.png"></img></a>
                    </div>

                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij ss">
                ...
                <div class="row ovcaRow">
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij cola">
                ...
                <div class="row ovcaRow">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 logoDiv-medij  sumens">
