                ...
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="setup-content" id="step-2">
                        <div class="col-xs-12 well">
                            ...
                            <a class="btn pull-left prethodni">Prethodni korak</a><a class="sljedeci btn pull-right">Sljedeći
                                korak</a>
                    ...
                    <div class="setup-content" id="step-3">
                        <div class="col-xs-12 well">
                            <p class="napomena">Motivaciono pismo je ključni kriterij prilikom izbora kandidata za
                                radionicu. Preporučujemo vam da pažljivo napišete što bolje motivaciono pismo kako biste
                                imali veće šanse za učešće na radionici.</p>
                    ...
                    <div class="setup-content" id="step-5">
                        <div class="col-xs-12 well">
                            <p class="napomena">Ukoliko smatrate da postoji još nešto važno što bismo trebali znati
                    ...
                    <div class="setup-content" id="step-6">
                        <div class="col-xs-12 well">
                            <p class="napomena">Klikom na dugme Pošalji prijavu Vaša prijava će biti poslana. Molimo Vas
                                da prije slanja još jednom provjerite da li ste ispravno popunili sve korake.</p>

                            <div class="form-group col-xs-12">
                                <input type="submit" name="prijavaSubmit" value="Pošalji prijavu"
