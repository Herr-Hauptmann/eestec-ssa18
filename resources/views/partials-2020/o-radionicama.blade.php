<div class="container-fluid">
  ...
  <div class="row">
    <!-- Trening 2 - tekst -->
    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8 col-8 order-2">
      <!-- SVG ovog lezbejskog para sto ublehari -->
    ...
    <div class="oblak_sivi_desni col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-3">
      <!--SVG oblaka s desne strane -->
    ...
    <div class="col-xl-6 col-lg-6 align-items-center radionice-opis order-lg-1 order-xl-1 order-4">
      <h2 class="radionice-naslov">Emotional inteligence</h2>
      <br>
      <p class="radionice-tekst">Istraživanja pokazuju da su osobe s većom emocionalnom inteligencijom obično puno uspješnije od osoba kod kojih ove osobine nisu razvijene.
        <br><br>
        Takve osobe nikada ne dopuštaju da ih savladaju negativne emocije (strah, ljutnja, bijes, tuga, krivnja), jer su u stanju razumjeti uzroke takvih emocija i iskoristiti ih za pozitivno djelovanje.
      </p>
    </div>
