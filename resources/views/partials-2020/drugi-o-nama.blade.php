<div class="containter-fluid pt-5 mt-5 pl-5" > 

<svg class="slicica" xmlns="http://www.w3.org/2000/svg" width="721.08" height="1254.738" viewBox="0 0 721.08 1254.738">
...
<svg class="tackice" xmlns="http://www.w3.org/2000/svg" width="424" height="424" viewBox="0 0 424 424">
...
{{-- <svg class="strelice" xmlns="http://www.w3.org/2000/svg" width="188.096" height="33.786" viewBox="0 0 188.096 33.786">
  <g id="Group_1520" data-name="Group 1520" transform="translate(-1143 -2451)">
    ...
    <g id="arrow-long-2" data-name="arrow-long" transform="translate(1192.096 2526.702) rotate(180)">
...
{{-- <div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><medium class="text-muted">Mujo Mujić</medium></p>
