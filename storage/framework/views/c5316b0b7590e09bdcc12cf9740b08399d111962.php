                      ...
                      <div class="row">
                        <div class="col-xs-12">
                          <span class="section-subtitle_period flex-row_nowrap">
                            Od: &nbsp;&nbsp; 
                            <?php echo Form::select('radno_iskustvo[0][mjesec_start]', ['Januar', 'Februrar', 'Mart', 'April', 'Maj', 'Juni', 'Juli', 'August', 'Septembar', 'Oktobar', 'Novembar', 'Decembar'], null, ['class' => 'cool-input', 'style' => 'width: auto']); ?>

                            <?php echo Form::select('radno_iskustvo[0][mjesec_godina]', range(date('Y'), 1990), null, ['class' => 'cool-input', 'style' => 'width: auto']); ?>
