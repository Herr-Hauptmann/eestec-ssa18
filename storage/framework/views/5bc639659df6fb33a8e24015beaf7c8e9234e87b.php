    ...
    <div class="row aboutProjectRowMargin">
        <div class="col-md-5 aboutProjectImgDiv">
            <div class="marginRight30">
                <img class="img-responsive aboutProjectImg" src="<?php echo e(asset('img/proba1.jpg')); ?>" />
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-5 aboutProjectImgDiv">
            <div class="marginLeft30">
                <img class="img-responsive aboutProjectImg" src="<?php echo e(asset('img/proba2.jpg')); ?>" />
            </div>
        </div>
    </div>
</section>