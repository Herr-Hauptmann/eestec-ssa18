        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('participant.register')); ?>">
...
<div class="modal modal-fade" id="registrationModalEmail">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('emailCheck')); ?>" method="POST" id="checkEmailForm">
...
<?php if(! session()->has('emailRemembered')): ?>
    <script>
